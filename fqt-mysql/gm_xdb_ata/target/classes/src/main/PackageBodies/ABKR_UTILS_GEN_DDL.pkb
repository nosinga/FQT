PROMPT CREATE OR REPLACE PACKAGE BODY ABKR_UTILS_GEN_DDL
...
--
  ...
  s_body_url        constant varchar (4000) := '$URL: http://nosinga@svn.ioo.rotterdam.nl/projecten/abkr/trunk/gm_xdb_ata/src/main/PackageBodies/ABKR_UTILS_GEN_DDL.pkb $';
  s_body_id         constant varchar (4000) := '$Id: ABKR_UTILS_GEN_DDL.pkb 20459 2010-07-02 06:34:38Z nosinga $';
