...
,      servicename    = 'beta-p:1521/gegmag.ioo.local'
,      tnsname        = 'beta-p'
,      description    = username||'@beta-p'
...
,      servicename    = 'twd139.resource.twd.rotterdam.nl:1521/gddata'
,      tnsname        = 'gddata_prd'
,      description    = username||'@gddata_prd'
...
,      servicename    = 'twd139.resource.twd.rotterdam.nl:1521/gmrdam'
,      tnsname        = 'gmrdam_prd'
,      description    = username||'@gmrdam_prd'
...
prompt update sqm_connections gn_out@gegmag
update sqm_connections
set    username       = 'gm_out_ro'
,      password       = '&&password_gm_out'
,      servicename    = 'twd139.resource.twd.rotterdam.nl:1521/gmrdam'
,      tnsname        = 'gmrdam_prd'
,      description    = username||'@gmrdam_prd'
