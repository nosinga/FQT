CREATE OR REPLACE package body fqt_utils
is
-----------------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
--SUBVERSION INFO : DO NOT CHANGE!!!!
  ...
  s_body_url          constant     varchar(4000) := '$URL: svn://store01/fqt-db/Packages/FQT_UTILS.pkb $';
  s_body_id           constant     varchar(4000) := '$Id: FQT_UTILS.pkb 5985 2011-04-22 12:16:27Z nanne $';
  -----------------------------------------------------------------------------------------------------------------------------------------
  -----------------------------------------------------------------------------------------------------------------------------------------
--
...
/* ******************************************************************************* */
  ...
  is
  begin
    return fqt_utils.ora_info (s_spec_date,
                               s_spec_revision,
                               s_spec_author,
                               s_spec_url,
                               s_spec_id,
