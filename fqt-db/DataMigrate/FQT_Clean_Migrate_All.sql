...
|||  Author   : $Author: nanne $
|||  URL      : $URL: svn://store01/fqt-db/DataMigrate/FQT_Clean_Migrate_All.sql $
|||  ID       : $Id: FQT_Clean_Migrate_All.sql 5985 2011-04-22 12:16:27Z nanne $
|||------------------------------------------------------------------------
**/
--
PROMPT ===============================================================================
PROMPT Partially Cleaning schema FQT
PROMPT ===============================================================================
-- ------------------------------------------------------------------------
-- HOOFDPROCEDURE
-- ------------------------------------------------------------------------
...
--
  ...
  is
    ...
    and    table_name not like 'URP_USERS_J%'
    and    table_name not like 'ZZ_URP_USERS%'
  ;
  -- OBJECTS
  cursor c_obj
  is
